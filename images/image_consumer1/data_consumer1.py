...
def consume_1(consumer, topic_name):
    ...
    print(f'{datetime.now()} {len(messages)} messages received on topic: {topic_name}')
...
wait_time = 60
print(f"{datetime.now()}: Waiting for producer .. {wait_time}sec")
